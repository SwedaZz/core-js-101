...
class Selector {
  ...
  element(value) {
    this.position = 0;
    if (this.elementExists) throw new Error(this.error.wrongOccurancy);
  ...
  id(value) {
    this.position = 1;
    if (this.idExists) throw new Error(this.error.wrongOccurancy);
    this.idExists = true;
    this.result += `#${value}`;
    return this;
  }
  ...
  pseudoElement(value) {
    this.position = 5;
    if (this.pseudoElementExists) throw new Error(this.error.wrongOccurancy);
    this.pseudoElementExists = true;
    this.result += `::${value}`;
    return this;
  }
